...
public struct XMLNode {
  ...
  @inline(__always)
  internal init(_ nodePtr: UnsafePointer<xmlNode>) {
  ...
  public var content: String? {
    ...
    guard let child = nodePtr.pointee.children,
      let contentPtr = xmlNodeListGetString(nodePtr.pointee.doc, child, 1)
    else {
      return nil
    }
    defer {
  ...
  public var children: XMLNodeSequence {
    XMLNodeSequence(current: nodePtr.pointee.children)
  }
}
